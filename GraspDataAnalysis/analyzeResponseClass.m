...
%Predictable
wherestring='Expt = 0 AND ExcludeSubject = 0 AND SubjectBlock = 1 AND FirstBlockType = "left" AND Congruent = 1';
...
wherestring='Expt = 0 AND ExcludeSubject = 0 AND SubjectBlock = 2 AND FirstBlockType = "left" AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0 AND ExcludeSubject = 0 AND SubjectBlock = 3 AND FirstBlockType = "left" AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0 AND ExcludeSubject = 0 AND SubjectBlock = 1 AND FirstBlockType = "right" AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0 AND ExcludeSubject = 0 AND SubjectBlock = 2 AND FirstBlockType = "right" AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 3 AND FirstBlockType = "right" AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
%Unpredictable
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 1 AND FirstBlockType = "left" AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 2 AND FirstBlockType = "left" AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 3 AND FirstBlockType = "left" AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 1 AND FirstBlockType = "right" AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 2 AND FirstBlockType = "right" AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 3 AND FirstBlockType = "right" AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 1 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 2 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 3 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 1 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 2 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 3 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Congruent = 1 AND TouchMode = "left"';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Congruent = 1 AND TouchMode = "right"';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
for i=1:size(subjects,1)
    ...
    wherestring=['Expt = 0  AND ExcludeSubject = 0 AND subject = ' num2str(subjects(i))];
    vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
    if isempty(vals)
        continue;
    end
...
wherestring='Expt = 0  AND ExcludeSubject = 0  AND Congruent = 1 AND (RespClass = "hit" OR RespClass = "miss")';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Congruent = 0 AND (RespClass = "hit" OR RespClass = "miss") AND Choice1Rotation IS NOT NULL';
vals=fetch(DataDB, ['Select SampleRotation, Choice1Rotation, RespClass, ReactionTime FROM trialsTable WHERE ' wherestring]);
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Congruent = 0 AND (RespClass = "hit" OR RespClass = "miss") AND Choice2Rotation IS NOT NULL';
...
%Predictable, same object
wherestring='Expt = 0 AND ExcludeSubject = 0 AND Congruent = 1 AND Aligned = 1';
...
wherestring='Expt = 0 AND ExcludeSubject = 0 AND Congruent = 0 AND Choice1Rotation IS NOT NULL AND Aligned = 1';
u=fetch(DataDB, ['Select SubjectBlock, Trial, ReactionTime FROM trialsTable WHERE ' wherestring]);
wherestring='Expt = 0 AND ExcludeSubject = 0 AND Congruent = 0 AND Choice2Rotation IS NOT NULL AND Aligned = 1';
...
wherestring='Expt = 0 AND ExcludeSubject = 0 AND Congruent = 0 AND (RespClass = "hit" OR RespClass = "miss") AND Choice1Rotation IS NOT NULL AND Aligned = 0';
ud=fetch(DataDB, ['Select SubjectBlock, Trial, ReactionTime FROM trialsTable WHERE ' wherestring]);
wherestring='Expt = 0 AND ExcludeSubject = 0 AND Congruent = 0 AND (RespClass = "hit" OR RespClass = "miss") AND Choice2Rotation IS NOT NULL AND Aligned = 0';
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Congruent = 0 AND RespClass = "hit"';
valsCH=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));

wherestring='Expt = 0  AND ExcludeSubject = 0 AND Congruent = 0 AND RespClass = "miss"';
valsCM=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));

wherestring='Expt = 0  AND ExcludeSubject = 0 AND Congruent = 0 AND RespClass = "fa"';
valsCF=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));

wherestring='Expt = 0  AND ExcludeSubject = 0 AND Congruent = 0 AND RespClass = "cr"';
...
for i=1:size(targets,1)
    ...
    wherestring=['Expt = 0  AND ExcludeSubject = 0 AND Congruent = 1 AND RespClass = "hit" AND Target = ' thisTarg];
    valsHC=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
    
    wherestring=['Expt = 0  AND ExcludeSubject = 0 AND Congruent = 1 AND RespClass = "miss" AND Target = ' thisTarg];
    valsMC=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
    
    wherestring=['Expt = 0  AND ExcludeSubject = 0 AND Congruent = 0 AND RespClass = "hit" AND Target = ' thisTarg];
    valsHI=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
    
    wherestring=['Expt = 0  AND ExcludeSubject = 0 AND Congruent = 0 AND RespClass = "miss" AND Target = ' thisTarg];
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 4 AND Congruent = 1';
subjects=unique(cellfun(@str2num,fetch(DataDB, ['Select Subject FROM trialsTable WHERE ' wherestring])));
subjects=[ones(length(subjects),1) subjects];
wherestring='Expt = 0  AND ExcludeSubject = 0 AND SubjectBlock = 4 AND Congruent = 0';
...
for i=1:size(subjects,1)
    ...
    firstr=[];
    for ii=1:4
        wherestring=['Expt = 0  AND Subject = ' s ' AND SubjectBlock = ' num2str(ii)];
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Instrument = 1 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Instrument = 2 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Instrument = 3 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Instrument = 1 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Instrument = 2 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Instrument = 3 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Instrument = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Instrument = 2';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Instrument = 3';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Sex = 0 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpC1 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsC1=mean(a);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Sex = 1 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpC2 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsC2=mean(a);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Sex = 0 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpI1 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsI1=mean(a);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Sex = 1 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpI2 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsI2=mean(a);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Age < 25 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpC1 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsC1=mean(a);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Age >=25 AND Age <= 30 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpC2 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsC2=mean(a);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Age > 30 AND Congruent = 1';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpC3 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsC3=mean(a);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Age < 25 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpI1 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsI1=mean(a);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND Age >=25 AND Age <= 30 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpI2 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsI2=mean(a);
...
wherestring='Expt = 0  AND ExcludeSubject = 0 AND  Age > 30 AND Congruent = 0';
vals=fetch(DataDB, ['Select RespClass FROM trialsTable WHERE ' wherestring]);
hitpI3 = calcRespClassCorrectRate(vals);
a=double(cell2mat(fetch(DataDB, ['Select ReactionTime FROM trialsTable WHERE ' wherestring])));
rtsI3=mean(a);
...
vals=double(cell2mat(fetch(DataDB, 'Select ReactionTime, GraspTime FROM trialsTable WHERE Expt = 0  AND ExcludeTrialGrasp = 0')));
trials=double(cell2mat(fetch(DataDB, 'Select UniqueTrial FROM trialsTable WHERE Expt = 0  AND GraspTime < 200 AND ExcludeTrialGrasp = 0')));
...
for s=1:size(subjects,1)
    ...
    rights=double(cell2mat(fetch(DataDB, ['Select UniqueTrial FROM trialsTable WHERE Expt = 0  AND TouchMode = "right" AND Subject = ' subject])));
    lefts=double(cell2mat(fetch(DataDB, ['Select UniqueTrial FROM trialsTable WHERE Expt = 0  AND TouchMode = "left" AND Subject = ' subject])));
...
I1=double(cell2mat(fetch(DataDB, ['Select GraspEyeCorr FROM trialsTable WHERE Expt = 0  AND Congruent = 0 AND Instrument = 1 AND SubjectBlock > 1 AND ExcludeSubject = 0 AND (RespClass = "hit" OR RespClass = "miss")'])));
I2=double(cell2mat(fetch(DataDB, ['Select GraspEyeCorr FROM trialsTable WHERE Expt = 0  AND Congruent = 0 AND Instrument = 2 AND SubjectBlock > 1 AND ExcludeSubject = 0 AND (RespClass = "hit" OR RespClass = "miss")'])));
I3=double(cell2mat(fetch(DataDB, ['Select GraspEyeCorr FROM trialsTable WHERE Expt = 0  AND Congruent = 0 AND Instrument = 3 AND SubjectBlock > 1 AND ExcludeSubject = 0 AND (RespClass = "hit" OR RespClass = "miss")'])));

C1=double(cell2mat(fetch(DataDB, ['Select GraspEyeCorr FROM trialsTable WHERE Expt = 0  AND Congruent = 1 AND Instrument = 1 AND ExcludeSubject = 0 AND (RespClass = "hit" OR RespClass = "miss")'])));
C2=double(cell2mat(fetch(DataDB, ['Select GraspEyeCorr FROM trialsTable WHERE Expt = 0  AND Congruent = 1 AND Instrument = 2 AND ExcludeSubject = 0 AND (RespClass = "hit" OR RespClass = "miss")'])));
C3=double(cell2mat(fetch(DataDB, ['Select GraspEyeCorr FROM trialsTable WHERE Expt = 0  AND Congruent = 1 AND Instrument = 3 AND ExcludeSubject = 0 AND (RespClass = "hit" OR RespClass = "miss")'])));
...
r2=[];
for i=1:size(subjects,1)    
    wherestring=['Expt = 0  AND ExcludeSubject = 0 AND subject = ' num2str(subjects(i)) ' AND Congruent = 0 AND Choice1ID IS NOT NULL'];
    congTrialsLeft=double(cell2mat(fetch(DataDB, ['Select UniqueTrial FROM trialsTable WHERE ' wherestring])));
    wherestring=['Expt = 0  AND ExcludeSubject = 0 AND subject = ' num2str(subjects(i)) ' AND Congruent = 0 AND Choice2ID IS NOT NULL'];
    congTrialsRight=double(cell2mat(fetch(DataDB, ['Select UniqueTrial FROM trialsTable WHERE ' wherestring])));
    wherestring=['Expt = 0  AND ExcludeSubject = 0 AND subject = ' num2str(subjects(i)) ' AND Congruent = 1  AND Choice1ID IS NOT NULL'];
    incongTrialsLeft=double(cell2mat(fetch(DataDB, ['Select UniqueTrial FROM trialsTable WHERE ' wherestring])));
    wherestring=['Expt = 0  AND ExcludeSubject = 0 AND subject = ' num2str(subjects(i)) ' AND Congruent = 1  AND Choice2ID IS NOT NULL'];
...
for i=1:size(subjects,1)    
    ...
    c=double(cell2mat(fetch(DataDB, ['Select GraspEyeCorr FROM trialsTable WHERE Expt = 0  AND subject = ' num2str(subjects(i)) ' AND (RespClass = "hit" OR RespClass = "miss")'])));    
...
for s=1:size(subjects,1)
    ...
    congruents=double(cell2mat(fetch(DataDB, ['Select UniqueTrial, SubjectBlock FROM trialsTable WHERE Expt = 0  AND Congruent = 1 AND Subject = ' subject])));
    incongruents=double(cell2mat(fetch(DataDB, ['Select UniqueTrial, SubjectBlock FROM trialsTable WHERE Expt = 0  AND Congruent = 0 AND Subject = ' subject])));    
