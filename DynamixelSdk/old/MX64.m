...
classdef MX64
	...
	% Dynamixel MX64 Control Table
		...
		% RAM AREA
		RAM_TORQUE_ENABLE             = 24; %need this 1
		RAM_LED                       = 25;
		RAM_DERIVATIVE_GAIN           = 26; %need this 0
		RAM_INTERGRAL_GAIN            = 27; %need this 0
		RAM_PROPORTIONAL_GAIN         = 28; %need this 32
		RAM_GOAL_POSITION_L           = 30;
		RAM_GOAL_POSITION_H           = 31;
		RAM_GOAL_SPEED_L              = 32; %need this 1023
		RAM_GOAL_SPEED_H              = 33;
		...
		RAM_GOAL_ACCELERATION		  = 73; %need this 30
    ...
    methods (Access = public)
        ...
        function accel(obj,ID,accel)
        %MX64.accel Set the acceleration
        %
        %   Dynamixel.accel(id, acceleration)

            calllib('dynamixel','dxl_write_byte',ID,obj.RAM_GOAL_ACCELERATION,accel)
