...
%            a table, then each row of the specified
%            data is assumed to correspond to a
%            single timestamp. For data specified as
%            a matrix the timestamp associated with
%            each row of the matrix needs to be
%            provided using the TIMESTAMP parameter.
